...
const sourceTokens = { [TOKEN_S]: true, [TOKEN_N]: true, [TOKEN_T]: true };
...
function parseParam(tokenizer) {
  ...
  while (tokenizer.hasNext()) {
    ...
    paramStr += token;
    if (token == TOKEN_N) break;
    if (!sign) {
      sign = { [TOKEN_S]: 1, [TOKEN_T]: -1 }[token];
    } else {
      value = (value << 1) + { [TOKEN_S]: 0, [TOKEN_T]: 1 }[token];
    }
  }
...
var ws = {
  ...
  compile: function (fullSource) {
    ...
    while (tokenizer.hasNext()) {
      ...
      debugToken += { [TOKEN_S]: "s", [TOKEN_T]: "t", [TOKEN_N]: "n" }[token];
...
ws.keywords = [
  ...
  {
    ws: TOKEN_S + TOKEN_N + TOKEN_S /*" \n "*/,
    mnemo: "dup",
    constr: ws.WsDouble,
    param: null,
  },
  {
    ws: TOKEN_S + TOKEN_T + TOKEN_S /*" \t "*/,
    mnemo: "copy",
    constr: ws.WsCopyNth,
    param: "NUMBER",
  },
  {
    ws: TOKEN_S + TOKEN_N + TOKEN_T /*" \n\t"*/,
    mnemo: "swap",
    constr: ws.WsSwapTop,
    param: null,
  },
  {
    ws: TOKEN_S + TOKEN_N + TOKEN_N /*" \n\n"*/,
    mnemo: "drop",
    constr: ws.WsDropTop,
    param: null,
  },
  {
    ws: TOKEN_S + TOKEN_T + TOKEN_N /*" \t\n"*/,
    mnemo: "slide",
    constr: ws.WsSlide,
    param: "NUMBER",
  },
  {
    ws: TOKEN_T + TOKEN_S + TOKEN_S + TOKEN_S /*"\t   "*/,
    mnemo: "add",
    constr: ws.WsAddition,
    param: null,
  },
  {
    ws: TOKEN_T + TOKEN_S + TOKEN_S + TOKEN_T /*"\t  \t"*/,
    mnemo: "sub",
    constr: ws.WsSubtraction,
    param: null,
  },
  {
    ws: TOKEN_T * TOKEN_S + TOKEN_S + TOKEN_N /*"\t  \n"*/,
    mnemo: "mul",
    constr: ws.WsMultiplication,
    param: null,
  },
  {
    ws: TOKEN_T + TOKEN_S + TOKEN_T + TOKEN_S /*"\t \t "*/,
    mnemo: "div",
    constr: ws.WsIntDivision,
    param: null,
  },
  {
    ws: TOKEN_T + TOKEN_S + TOKEN_T + TOKEN_T /*"\t \t\t"*/,
    mnemo: "mod",
    constr: ws.WsModulo,
    param: null,
  },
  {
    ws: TOKEN_T + TOKEN_T + TOKEN_S /*"\t\t "*/,
    mnemo: "store",
    constr: ws.WsHeapStore,
    param: null,
  },
  {
    ws: TOKEN_T + TOKEN_T + TOKEN_T /*"\t\t\t"*/,
    mnemo: "retrieve",
    constr: ws.WsHeapRetrieve,
    param: null,
  },
  {
    ws: TOKEN_N + TOKEN_S + TOKEN_S /*"\n  "*/,
    mnemo: "label",
    constr: ws.WsLabel,
    param: "LABEL",
  },
  {
    ws: TOKEN_N + TOKEN_S + TOKEN_T /*"\n \t"*/,
    mnemo: "call",
    constr: ws.WsCall,
    param: "LABEL",
  },
  {
    ws: TOKEN_N + TOKEN_S + TOKEN_N /*"\n \n"*/,
    mnemo: "jmp",
    constr: ws.WsJump,
    param: "LABEL",
  },
  {
    ws: TOKEN_N + TOKEN_T + TOKEN_S /*"\n\t "*/,
    mnemo: "jz",
    constr: ws.WsJumpZ,
    param: "LABEL",
  },
  {
    ws: TOKEN_N + TOKEN_T + TOKEN_T /*"\n\t\t"*/,
    mnemo: "jn",
    constr: ws.WsJumpNeg,
    param: "LABEL",
  },
  {
    ws: TOKEN_N + TOKEN_T + TOKEN_N /*"\n\t\n"*/,
    mnemo: "ret",
    constr: ws.WsReturn,
    param: null,
  },
  {
    ws: TOKEN_N + TOKEN_N + TOKEN_N /*"\n\n\n"*/,
    mnemo: "end",
    constr: ws.WsEndProgram,
    param: null,
  },
  {
    ws: TOKEN_T + TOKEN_N + TOKEN_S + TOKEN_S /*"\t\n  "*/,
    mnemo: "printc",
    constr: ws.WsPrintChar,
    param: null,
  },
  {
    ws: TOKEN_T + TOKEN_N + TOKEN_S + TOKEN_T /*"\t\n \t"*/,
    mnemo: "printi",
    constr: ws.WsPrintNum,
    param: null,
  },
  {
    ws: TOKEN_T + TOKEN_N + TOKEN_T + TOKEN_S /*"\t\n\t "*/,
    mnemo: "readc",
    constr: ws.WsReadChar,
    param: null,
  },
  {
    ws: TOKEN_T * TOKEN_N + TOKEN_T + TOKEN_T /*"\t\n\t\t"*/,
    mnemo: "readi",
    constr: ws.WsReadNum,
    param: null,
  },
